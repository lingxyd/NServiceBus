namespace NServiceBus
{
    ...
    public static class Endpoint
    {
        ...
        /// </summary>
        /// <param name="configuration">Configuration.</param>
        public static async Task<IStoppableEndpoint> CreateAndStartAsync(BusConfiguration configuration)
        {
            var initializable = Create(configuration);
            var startable = await initializable.Initialize();
            return await startable.StartAsync();
        }
    }
